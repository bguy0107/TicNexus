...
export function FranchiseTable() {
  ...
  const handleDelete = async (id: string, name: string) => {
    if (!confirm(`Delete franchise "${name}"? This cannot be undone.`)) return
            ...
            {franchises.length === 0 ? (
              ...
              franchises.map((f) => (
                <TableRow key={f.id}>
                  ...
                  <TableCell>{f._count.userFranchises}</TableCell>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem className="text-destructive cursor-pointer" onClick={() => handleDelete(f.id, f.name)}>
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
